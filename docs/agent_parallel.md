...
| --- | --- | --- |
| `std/collections.ouro`, `tests/practical_stdlib_tests.ouro` | reservation; live [#38](https://github.com/eluvane/ouro/pull/38) | RESERVED. No second collections writer; do not hand-edit generated API pages or baselines. |
